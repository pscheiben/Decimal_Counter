...
## RGB LED
# set_property -dict { PACKAGE_PIN B17   IOSTANDARD LVCMOS33 } [get_ports { SEG_SELECT[1] }]; #IO_L14N_T2_SRCC_16 Sch=led0_b
# set_property -dict { PACKAGE_PIN B16   IOSTANDARD LVCMOS33 } [get_ports { SEG_SELECT[2] }]; #IO_L13N_T2_MRCC_16 Sch=led0_g
# set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { SEG_SELECT[3] }]; #IO_L14P_T2_SRCC_16 Sch=led0_r
...
#  CG	 5		34      DEC_OUT[6]
#  CP	 3		32      DEC_OUT[7]
# AN1	12		 1   SEG_SELECT[0]
# AN2	 9		 3   SEG_SELECT[1]
# AN3	 8		 2   SEG_SELECT[2]
# AN4	 6		48   SEG_SELECT[3]
